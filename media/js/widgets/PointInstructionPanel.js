...
gwst.widgets.PointInstructionPanel = Ext.extend(gwst.widgets.WestPanel, {
    // Constructor Defaults, can be overridden by user's config object
    initComponent: function(){
		
        // Call parent (required)
        gwst.widgets.PointInstructionPanel.superclass.initComponent.apply(
          this, arguments);                     
    },

    onRender: function(){
		this.panel_one = new Ext.Panel({		
			html: gwst.settings.point_panel_one_instructions,
        ...
        // Call parent (required)
        gwst.widgets.PointInstructionPanel.superclass.onRender.apply(this, arguments);     
	},
...
Ext.reg('gwst-point-instr-panel', gwst.widgets.PointInstructionPanel);