...
gwst.widgets.AccessQuestionsPanel = Ext.extend(gwst.widgets.GroupQuestionsPanel, {
    ...
    buildSelectPanel: function(order, outside_box, abalone_text, abalone_box){
        this.select_panel = new Ext.Panel({
            ...
            items: [{
        		html:'Where did you previously target this fishery in 2009?',
        		border: false,
    ...
    buildFacade: function() {
        this.facade = new Ext.FormPanel({
            ...
            items: [{
                    ...
                    id: 'facade_block_1',
                    checkboxToggle: true,
                    title: 'In 2009, did you target this fishery in <br />locations you did not return to in 2010?',
                    autoHeight: true,
                    width: 260,
                    ...
                    items: [
                        ...
                        new Ext.form.ComboBox({
                            ...
                            fieldLabel: ' Why did you not return to this location in 2010 to target this fishery?',
                            editable: false,
                            triggerAction: 'all',
                            border: false,
                            listWidth: 250,
