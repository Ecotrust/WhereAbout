...
gwst.widgets.CumulPolyPanel = Ext.extend(gwst.widgets.WestPanel, {
    id: 'poly-panel',
    activity_num: null,
    ...
    initComponent: function(){		
        ...
        gwst.widgets.CumulPolyPanel.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function(){
        ...
        this.header_panel = new Ext.Container({  
			autoEl: {tag:'div', cls:'action-panel-header', id:'header_html_poly', html:this.getHeaderText()},
			style: 'padding:5px',
            id: 'intro_header_panel_poly',
			border: false   
        });
        ...
        this.nav_panel = new Ext.Panel({
        	...
        	style: 'padding: 5px',
        	items: [{
        		html:gwst.settings.step1CumulText,
        		border: false,
        ...
        this.poly_panel = new Ext.Panel({
        	id:'poly-inner-panel',
        	border: false,
        	style: 'padding: 5px',
        	items: [{
        		html:gwst.settings.polyDrawText,
        		border: false,
        		style:'padding: 10px 3px 3px 3px'
        	},{
        		border: false,
        		cls: 'poly-image',
        		html:gwst.settings.polyImgText
        	}]        	        
        });            
        
        this.repeat_panel = new Ext.Panel({
        	id:'repeat-panel-poly',
        	border: false,
        	style: 'padding: 5px',
        	items: [{
        		html: gwst.settings.cumulRepeatPolyText,
        		border: false,
        ...
        this.add(this.poly_panel);        
        this.add(this.repeat_panel);
        this.add(this.button_panel);
    
        // Call parent (required)
        gwst.widgets.CumulPolyPanel.superclass.onRender.apply(this, arguments);     
	},
    ...
    update: function(config) {
        ...
        Ext.get('header_html_poly').update(this.getHeaderText());
    },
...
Ext.reg('gwst-cumul-poly-panel', gwst.widgets.CumulPolyPanel);