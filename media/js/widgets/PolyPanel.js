...
gwst.widgets.PolyPanel = Ext.extend(gwst.widgets.WestPanel, {
    id: 'poly-panel',
    activity_num: null,
    ...
    initComponent: function(){		
        ...
        gwst.widgets.PolyPanel.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function(){
        ...
        this.repeat_panel = new Ext.Panel({
        	...
        	style: 'padding: 5px',
        	items: [{
        		html: gwst.settings.repeatPolyText,
        		border: false,
        ...
        // Call parent (required)
        gwst.widgets.PolyPanel.superclass.onRender.apply(this, arguments);     
	},
...
Ext.reg('gwst-poly-panel', gwst.widgets.PolyPanel);