...
gwst.widgets.CumulPointPanel = Ext.extend(gwst.widgets.WestPanel, {
    id: 'point-panel',
    activity_num: null,
    ...
    initComponent: function(){		
        ...
        gwst.widgets.CumulPointPanel.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function(){
        ...
        this.repeat_panel = new Ext.Panel({
        	...
        	style: 'padding: 5px',
        	items: [{
        		html: gwst.settings.cumulRepeatPointText,
        		border: false,
        ...
        // Call parent (required)
        gwst.widgets.CumulPointPanel.superclass.onRender.apply(this, arguments);     
	},
...
Ext.reg('gwst-cumul-point-panel', gwst.widgets.CumulPointPanel);