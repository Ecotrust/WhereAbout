...
gwst.widgets.PolyInstructionPanel = Ext.extend(gwst.widgets.WestPanel, {
    activity: 'None',
    ...
    initComponent: function(){
        ...
        gwst.widgets.PolyInstructionPanel.superclass.initComponent.apply(
          this, arguments);                     
    },
    ...
    onRender: function(){
        ...
        // Call parent (required)
        gwst.widgets.PolyInstructionPanel.superclass.onRender.apply(this, arguments);     
	},
...
Ext.reg('gwst-poly-instr-panel', gwst.widgets.PolyInstructionPanel);