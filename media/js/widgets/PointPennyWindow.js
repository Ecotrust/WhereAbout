...
gwst.widgets.PointPennyWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function(){
        this.pennies_field = new Ext.form.NumberField ({
            fieldLabel: 'Pennies',
            id: 'point-penny-window-numfield',
            name: 'pennies',
            allowBlank:false,
            allowDecimals: false,
            width: 100,
        ...
        this.penny_form = new Ext.form.FormPanel({  
            ...
            id: 'point-penny-window-form-panel',
		...
		gwst.widgets.PointPennyWindow.superclass.initComponent.call(this);
	},
...
Ext.reg('gwst-point-penny-window', gwst.widgets.PointPennyWindow);