...
gwst.widgets.SingleResFinishPanel = Ext.extend(gwst.widgets.WestPanel, {
    id: 'single-res-finish-panel',
    ...
    initComponent: function(){
		...
		this.addEvents('continue-mapping');
        this.addEvents('finish-map');
		
        // Call parent (required)
        gwst.widgets.SingleResFinishPanel.superclass.initComponent.apply(
          this, arguments);                     
    },
    ...
    onRender: function(){
		this.inner_panel = new Ext.Panel({
            ...
            id: 'single_res_finish_inner_panel',
			style: 'margin: 10px',
			border: false
		});
        ...
        this.button_panel = new gwst.widgets.CustomButtons ({
            element_list: [{
                elem: this.continueBtnClicked.createDelegate(this),
                type: 'handler'
            },{
                elem: 'Continue mapping',
                type: 'text'
            },{
            	elem: 'Continue mapping this '+ this.res_group_name,
            	type: 'text'            	
            },{
    ...
    continueBtnClicked: function() {
        this.fireEvent('continue-mapping',this);
    },
...
Ext.reg('gwst-single-res-finish-panel', gwst.widgets.SingleResFinishPanel);