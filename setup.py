...
class InnoScript:
    ...
    def create(self, pathname="dist\\DesktopGWST.iss"):
        ...
        print >> ofi, r"VersionInfoDescription=CA Central Coast Commercial And Charter Monitoring 2012 v%s" % self.version
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("CCAC 2012 Commercial Charter",
                            lib_dir,
                            dist_dir,
