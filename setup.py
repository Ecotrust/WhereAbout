...
class InnoScript:
    ...
    def create(self, pathname="dist\\DesktopGWST.iss"):
        ...
        print >> ofi, r"VersionInfoDescription=CA Central Coast Commercial And Charter Monitoring 2011 v%s" % self.version
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("CCAC 2011 Commercial Charter",
                            lib_dir,
                            dist_dir,
